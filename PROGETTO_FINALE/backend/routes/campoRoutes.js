...
// POST /api/campi/:campoId/recensioni- L'Utente pubblica una recensione sotto al campo con campoID specificato - Protetto, solo l'utente
router.post('/:campoId', verifyAccessToken, campoController.createRecensione);//solo utenti autenticati possono creare la recensione sotto a un campo


// DELETE /api/campi/recesioni/:recensioneId - Elimina una recensione tramite id recensioni - Protetto, solo l'utente
...
router.post('/:campoId', verifyAccessToken, campoController.prenotaCampo);//solo utenti autenticati possono prenotare il campo
